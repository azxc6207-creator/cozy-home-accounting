...
<style>
    ...
    html, body, [class*="css"], .stApp {
        ...
        background-image: 
            url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="260" height="260" viewBox="0 0 260 260"><g transform="translate(15,15) scale(1.6666666666666667)"><g fill="none" stroke="%23F5A623" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" opacity="0.1"><ellipse cx="6" cy="10" rx="1.8" ry="2.4"/><ellipse cx="10" cy="7" rx="2" ry="2.6"/><ellipse cx="14.5" cy="7" rx="2" ry="2.6"/><ellipse cx="18.5" cy="10" rx="1.8" ry="2.4"/><path d="M12 12c-3 0-5.5 1.8-5.5 4.2 0 2.3 2.3 3.8 5.5 3.8s5.5-1.5 5.5-3.8c0-2.4-2.5-4.2-5.5-4.2z"/></g></g><g transform="translate(90,10) scale(3.5416666666666665)"><path d="M4 8c0-2 1.5-3.5 3.5-3.5 .5 0 1 .1 1.5 .3 M7 3.5c.5-1 1.5-1.5 2.5-1 .8 .4 1 1.3 .8 2.2 M9.5 4.8c2.5 .3 5 2 6 5 M15.5 9.8c2-1 4-.5 4.5 1.2 .4 1.4-.5 2.5-1.8 2.6 M18.2 13.6c-1.2 .3-2.2 1.3-2.2 3v4 M4 8c-1 .3-1.8 1-1.8 2 0 1.3 1.3 1.8 2.6 2.2 1.5 .5 2.4 1.3 2.7 3 .3 2-.2 4-1.5 5.3 M6 20.5c-.8 0-1.5 .3-2 1 M4 21.5h4 M9.5 15c-1.3 .3-2.3 1.5-2 3 .2 1 1 1.8 2 2 M9.5 20c-1 0-1.7 .4-2 1.2 .3 .5 1 .8 1.7 .8h9.3c1 0 1.5-.5 1.5-1.5v-3.5" fill="none" stroke="%23FFC857" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" opacity="0.1"/></g><g transform="translate(190,30) scale(2.2916666666666665)"><g fill="none" stroke="%23F5A623" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" opacity="0.1"><ellipse cx="6" cy="10" rx="1.8" ry="2.4"/><ellipse cx="10" cy="7" rx="2" ry="2.6"/><ellipse cx="14.5" cy="7" rx="2" ry="2.6"/><ellipse cx="18.5" cy="10" rx="1.8" ry="2.4"/><path d="M12 12c-3 0-5.5 1.8-5.5 4.2 0 2.3 2.3 3.8 5.5 3.8s5.5-1.5 5.5-3.8c0-2.4-2.5-4.2-5.5-4.2z"/></g></g><g transform="translate(10,120) scale(2.5)"><path d="M4 8c0-2 1.5-3.5 3.5-3.5 .5 0 1 .1 1.5 .3 M7 3.5c.5-1 1.5-1.5 2.5-1 .8 .4 1 1.3 .8 2.2 M9.5 4.8c2.5 .3 5 2 6 5 M15.5 9.8c2-1 4-.5 4.5 1.2 .4 1.4-.5 2.5-1.8 2.6 M18.2 13.6c-1.2 .3-2.2 1.3-2.2 3v4 M4 8c-1 .3-1.8 1-1.8 2 0 1.3 1.3 1.8 2.6 2.2 1.5 .5 2.4 1.3 2.7 3 .3 2-.2 4-1.5 5.3 M6 20.5c-.8 0-1.5 .3-2 1 M4 21.5h4 M9.5 15c-1.3 .3-2.3 1.5-2 3 .2 1 1 1.8 2 2 M9.5 20c-1 0-1.7 .4-2 1.2 .3 .5 1 .8 1.7 .8h9.3c1 0 1.5-.5 1.5-1.5v-3.5" fill="none" stroke="%23FFC857" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" opacity="0.1"/></g><g transform="translate(110,150) scale(1.4583333333333333)"><g fill="none" stroke="%23F5A623" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" opacity="0.1"><ellipse cx="6" cy="10" rx="1.8" ry="2.4"/><ellipse cx="10" cy="7" rx="2" ry="2.6"/><ellipse cx="14.5" cy="7" rx="2" ry="2.6"/><ellipse cx="18.5" cy="10" rx="1.8" ry="2.4"/><path d="M12 12c-3 0-5.5 1.8-5.5 4.2 0 2.3 2.3 3.8 5.5 3.8s5.5-1.5 5.5-3.8c0-2.4-2.5-4.2-5.5-4.2z"/></g></g><g transform="translate(170,140) scale(2.9166666666666665)"><path d="M4 8c0-2 1.5-3.5 3.5-3.5 .5 0 1 .1 1.5 .3 M7 3.5c.5-1 1.5-1.5 2.5-1 .8 .4 1 1.3 .8 2.2 M9.5 4.8c2.5 .3 5 2 6 5 M15.5 9.8c2-1 4-.5 4.5 1.2 .4 1.4-.5 2.5-1.8 2.6 M18.2 13.6c-1.2 .3-2.2 1.3-2.2 3v4 M4 8c-1 .3-1.8 1-1.8 2 0 1.3 1.3 1.8 2.6 2.2 1.5 .5 2.4 1.3 2.7 3 .3 2-.2 4-1.5 5.3 M6 20.5c-.8 0-1.5 .3-2 1 M4 21.5h4 M9.5 15c-1.3 .3-2.3 1.5-2 3 .2 1 1 1.8 2 2 M9.5 20c-1 0-1.7 .4-2 1.2 .3 .5 1 .8 1.7 .8h9.3c1 0 1.5-.5 1.5-1.5v-3.5" fill="none" stroke="%23FFC857" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" opacity="0.1"/></g></svg>'),
...
components.html(
    ...
    function optimizeMobileInputs() {
        ...
        // 1.6 日曆上方「切換年份／切換月份」下拉選單：禁止跳出鍵盤，只允許點選
        doc.querySelectorAll('div[data-baseweb="select"] input').forEach(input => {
            const label = input.getAttribute('aria-label') || '';
            if ((label.includes('切換年份') || label.includes('切換月份')) && !input.hasAttribute('readonly')) {
                input.setAttribute('readonly', 'readonly');
                input.setAttribute('inputmode', 'none');
            }
        });
